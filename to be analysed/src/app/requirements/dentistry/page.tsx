...
export const metadata: Metadata = {
    title: 'Faculty of Dentistry — Entry Requirements | UEC',
    description: 'Entry requirements for the UEC Faculty of Dentistry. Accepted certificates: Egyptian Secondary, IGCSE, American Diploma, IB, Canadian, Abitur, French Baccalauréat, Nigerian, and more.',
};
...
export default function DentistryRequirementsPage() {
    return (
        <main>
            <RevealScript />
            <PageHeader
                ...
                <div className="container">
                    <div className="reveal">
                        ...
                        <p className="section-sub" style={{ maxWidth: '780px' }}>
                            The Faculty of Dentistry at UEC accepts applications from holders of the following certificate types.
