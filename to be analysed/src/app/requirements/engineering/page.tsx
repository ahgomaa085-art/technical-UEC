...
export const metadata: Metadata = {
    title: 'Faculty of Engineering — Entry Requirements | UEC',
    description: 'Entry requirements for the UEC Faculty of Engineering. Accepted certificates: Egyptian Secondary (Math), IGCSE, American Diploma, IB, Canadian, Abitur, French Baccalauréat, Nigerian, and more.',
};
...
const requirements = [
    {
        ...
        icon: '🇪🇬',
        criteria: ['Scientific Mathematics section only.'],
        requiredDocuments: {
    ...
    },
    {
        ...
        criteria: [
            ...
            'In addition to the required 8 O.L. subjects, A.S.L. or A.L. Mathematics with minimum grade "D" or "4".',
            'Accepted scores must be taken during not more than 4 successive years with no maximum IGCSE sittings.',
        ],
        qualifyingSubjects: [
            'English Language or Literature',
            'Mathematics',
            'A.S.L. or A.L. Mathematics',
            'Chemistry',
            'Physics',
            '+ 4 more different subjects from the list approved by the Egyptian Ministry of Higher Education',
        ],
        requiredDocuments: {
            inside: [
    ...
    },
    {
        ...
        criteria: [
            ...
            'To add SAT2/EST2/ACT2: Mathematics in addition to Biology or Chemistry or Physics.',
        ],
        qualifyingSubjects: [
            'English Language or Literature',
            'Mathematics',
            ...
            'Chemistry',
            'Physics',
            '+ 4 more different subjects from the list approved by the Egyptian Ministry for Higher Education',
        ],
        requiredDocuments: {
            inside: [
    ...
    },
    {
        ...
        criteria: [
            ...
            'Year 12 must include Mathématiques subject.',
...
export default function EngineeringRequirementsPage() {
    return (
        <main>
            <RevealScript />
            <PageHeader
                ...
                <div className="container">
                    <div className="reveal">
                        ...
                        <p className="section-sub" style={{ maxWidth: '780px' }}>
                            The Faculty of Engineering at UEC accepts applications from holders of the following certificate types.
