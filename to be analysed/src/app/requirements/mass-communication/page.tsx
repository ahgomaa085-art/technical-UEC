...
export const metadata: Metadata = {
    title: 'Faculty of Mass Communication — Entry Requirements | UEC',
    description: 'Entry requirements for the UEC Faculty of Mass Communication. Accepted certificates: Egyptian Secondary, IGCSE, American Diploma, IB, Canadian, Abitur, French Baccalauréat, Nigerian, and more.',
};
...
const requirements = [
    {
        ...
        icon: '🇪🇬',
        criteria: ['Scientific sections (Science & Math branches) and Art section are accepted.'],
        requiredDocuments: {
    ...
    },
    {
        ...
        qualifyingSubjects: [
            'English Language or Literature',
            '+ 5 more different subjects from the list approved by the Egyptian Ministry',
        ],
        requiredDocuments: {
            inside: [
    ...
    },
    {
        ...
        criteria: [
            ...
            'Passing mark is 10.',
            'French Oral & French Écrit are calculated as one subject.',
        ],
        requiredDocuments: {
            inside: [
    ...
    },
    {
        ...
        qualifyingSubjects: [
            'English Language or Literature',
            '+ 7 more different subjects from the list approved by the Egyptian Ministry for Higher Education',
        ],
        requiredDocuments: {
...
export default function MassCommRequirementsPage() {
    return (
        <main>
            <RevealScript />
            <PageHeader
                ...
                <div className="container">
                    <div className="reveal">
                        ...
                        <p className="section-sub" style={{ maxWidth: '780px' }}>
                            The Faculty of Mass Communication at UEC accepts applications from holders of the following certificate types.
