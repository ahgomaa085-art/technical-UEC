...
export const metadata: Metadata = {
    title: 'Faculty of Medicine — Entry Requirements | UEC',
    description: 'Entry requirements for the UEC Faculty of Medicine. Accepted certificates: Egyptian Secondary, IGCSE, American Diploma, IB, Canadian, Abitur, Nigerian, and more.',
};
...
const requirements = [
    ...
    },
    {
        ...
        requiredDocuments: {
            inside: [
                ...
                'Original enrollment letter of 12 years of schooling Stamped by the school & the Educational Zone (OR 3rd preparatory/6th primary + enrollment equivalents).',
                'Original Arabic & religion certificate approved by the General Administration of Examinations on Amin Sami Street (Al-Munira) only.'
            ],
            outside: [
                'Original Statements OR Certificates Stamped by the British Council and the Egyptian Ministry of Foreign Affairs.',
                'Original enrollment letter of 12 years of schooling Stamped by the Egyptian Embassy OR the Egyptian Ministry of Foreign Affairs (OR 3rd preparatory/6th primary + enrollment equivalents).',
    ...
    },
    {
        ...
        requiredDocuments: {
            inside: [
                ...
                'Letter of Private Education (Proof of registration in the Ministry of Education) — certified copy from the school.',
                'Original enrollment letter of 12 years of schooling Stamped by the school & the Educational Zone (OR alternatives).',
            ...
            outside: [
                ...
                'ACT OR EST Stamped by the General Administration of Examinations in Egypt.',
                'Username/password for the S.A.T, ACT OR EST.',
                'Accreditation Letter from AMIDEAST-Egypt, Stamped by the Egyptian Ministry of Foreign Affairs.',
                'Original enrollment letter of 12 years of schooling Stamped by the Egyptian Embassy OR MoFA (OR alternatives).',
                'Original Arabic & religion certificate Stamped by the Egyptian Embassy OR the Egyptian Ministry of Foreign Affairs.'
            ]
        },
        notes: [
    ...
    },
    {
        ...
        requiredDocuments: {
            ...
            outside: [
                ...
                'Original enrollment letter of 12 years of schooling Stamped by the Egyptian Consulate in Canada OR the Ministry of Foreign Affairs in Egypt (OR alternatives).',
                'Original Arabic & religion certificate Stamped by the Egyptian Embassy OR the Egyptian Ministry of Foreign Affairs.'
            ]
        }
    },
    {
        ...
        requiredDocuments: {
            inside: [
                'Abitur-Certificate Stamped by the Ministry of Foreign Affairs in Egypt and translated (English/Arabic).',
                'Original enrollment letter of 12 years of schooling Stamped by the school and the Educational Zone (OR alternatives).',
                'Original Arabic & religion certificate approved by the General Administration of Examinations (Amin Sami St).'
            ],
            outside: [
                'Abitur-Certificate Stamped by the Egyptian Embassy OR the Ministry of Foreign Affairs in Egypt and translated (English/Arabic).',
                'Original enrollment letter of 12 years of schooling Stamped by the Egyptian Embassy (OR alternatives).',
                'Original Arabic & religion certificate Stamped by the Egyptian Embassy OR the Egyptian Ministry of Foreign Affairs.'
            ]
        }
    },
...
export default function MedicineRequirementsPage() {
    return (
        <main>
            <RevealScript />
            <PageHeader
                ...
                <div className="container">
                    <div className="reveal">
                        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '10px' }}>
                            <Link href="/requirements" style={{ color: 'var(--muted)', fontSize: '0.95rem', textDecoration: 'none' }}>
                                ← All Faculties
                            </Link>
                        </div>
                        ...
                        <p className="section-sub" style={{ maxWidth: '780px' }}>
                            The Faculty of Medicine at UEC accepts applications from holders of the following certificate types.
                    ...
                    <div className="reveal" style={{ marginTop: '60px', display: 'flex', gap: '20px', flexWrap: 'wrap' }}>
                        <Link href="/tuition" className="btn-primary" style={{ background: 'var(--navy)', color: 'white', padding: '14px 30px', borderRadius: '10px', fontWeight: '700', textDecoration: 'none', fontSize: '1rem' }}>
                            View Tuition & Fees →
                        </Link>
                        <Link href="https://apply.uec.edu.eg" className="btn-primary" style={{ background: 'var(--gold)', color: 'var(--navy)', padding: '14px 30px', borderRadius: '10px', fontWeight: '700', textDecoration: 'none', fontSize: '1rem' }}>
                            Apply Now →
                        </Link>
                    </div>
                </div>
