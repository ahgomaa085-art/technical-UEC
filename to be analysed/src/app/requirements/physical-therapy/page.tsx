...
export const metadata: Metadata = {
    title: 'Faculty of Physical Therapy — Entry Requirements | UEC',
    description: 'Entry requirements for the UEC Faculty of Physical Therapy across all accepted certificate types.',
};
...
const requirements = [
    ...
    },
    {
        ...
        requiredDocuments: {
            ...
            outside: [
                ...
                'Original enrollment letter of 12 years of schooling Stamped by the Egyptian Embassy OR the Egyptian Ministry of Foreign Affairs (OR alternatives).',
    ...
    },
    {
        ...
        criteria: [
            ...
            'Minimum score for SAT1 / EST1 is 800 degrees; ACT1 passing grade is 14.',
            'Minimum score for SAT2 / EST2 / ACT2 is 900 degrees (optional but recommended).',
        ],
        qualifyingSubjects: [
            'English Language or Literature',
            'Any branch of Mathematics',
    ...
    },
    {
        ...
        requiredDocuments: {
            inside: [
                'Abitur-Certificate Stamped by the Ministry of Foreign Affairs in Egypt and translated.',
                'Original enrollment letter of 12 years of schooling Stamped by the school and the Educational Zone (OR alternatives).',
                'Original Arabic & religion certificate approved by the General Administration of Examinations (Amin Sami St).'
            ],
            outside: [
                'Abitur-Certificate Stamped by the Egyptian Embassy OR the Ministry of Foreign Affairs in Egypt and translated.',
...
export default function PhysicalTherapyRequirementsPage() {
    return (
        <main>
            <RevealScript />
            <PageHeader
                ...
                <div className="container">
                    <div className="reveal">
                        ...
                        <p className="section-sub" style={{ maxWidth: '780px' }}>
                            The Faculty of Physical Therapy at UEC accepts applications from holders of the following certificate types.
